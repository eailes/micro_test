...
import com.example.esi.model.MarketHistoryResponse;
import com.example.esi.model.MarketOrdersResponse;
import com.example.esi.model.MarketPricesResponse;
...
public class MarketApi {
    ...
    public List<MarketOrdersResponse> getMarketsStructureOrders(Long structureId, String datasource) throws ApiException {
        Object localVarPostBody = null;

        // verify the required parameter 'regionId' is set
        if (structureId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'structureId' when calling getMarketsStructureOrders");
        }
