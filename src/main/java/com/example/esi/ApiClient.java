...
import com.example.esi.auth.ApiKeyAuth;
import com.example.esi.auth.Authentication;
import com.example.esi.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    public ApiClient setDateFormat(DateFormat dateFormat) {
        ...
        // also set the date format for dto (de)serialization with Date
        // properties
